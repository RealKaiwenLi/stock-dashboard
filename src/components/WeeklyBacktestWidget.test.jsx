...
const copy = { eyebrow: 'Weekly', title: 'Weekly Backtests', syncedAt: String, loading: 'Loading', error: 'Error', retry: 'Retry', empty: 'Empty', weekSelector: 'Weeks', weekOf: 'Week', report: 'Report', latestBar: 'Latest bar', assets: 'Assets', generatedAt: 'Generated', openNotion: 'Open Notion', columns: { rank: 'Rank', strategy: 'Strategy', score: 'Score', riskFlag: 'Risk flag', cagr: 'CAGR', excessCagr: 'Excess CAGR', maxDrawdown: 'Max drawdown', drawdownRatio: 'Drawdown/QQQ', sharpe: 'Sharpe', winRate: '5Y win rate', dcaLead: 'DCA lead vs QQQ', switches: 'Switches/year', note: 'Note' } }
const data = { items: [{ reportDate: '2026-07-17', title: 'Test', summary: [{ rank: 1, strategy: 'Alpha', score: 80, riskFlag: 'HIGH_DD', excessCagrPct: 12.34, maxDrawdownRatio: 1.2, dcaVsSignalPct: 42.5, note: 'Alpha note' }, { rank: 2, strategy: 'Beta', score: 90 }] }] }
